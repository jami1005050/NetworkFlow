...
if __name__ == '__main__':
    ...
    constantMatrix[0][0] = -2
    constantMatrix[0][1] = -1
    constantMatrix[1][0] = -2
    constantMatrix[1][1] = -3
    constantMatrix[2][0] = -3
    constantMatrix[2][1] = -1
    right_side_constants = [0 for i in range(numberOfRows)]
    right_side_constants[0] = 18
    right_side_constants[1] = 42
    right_side_constants[2] = 24
